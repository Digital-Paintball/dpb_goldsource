...
#define REAL_EXPORT _declspec( dllexport )
#else
#define EXPORT	/* */
#define REAL_EXPORT	/* */
#endif

extern "C" REAL_EXPORT int GetEntityAPI( DLL_FUNCTIONS *pFunctionTable, int interfaceVersion );
extern "C" REAL_EXPORT int GetEntityAPI2( DLL_FUNCTIONS *pFunctionTable, int *interfaceVersion );
