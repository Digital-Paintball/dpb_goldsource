...
typedef int HSPRITEZ;	// handle to a graphic
...
{
	// sprite handlers
	HSPRITEZ						( *pfnSPR_Load )			( const char *szPicName );
	int							( *pfnSPR_Frames )			( HSPRITEZ hPic );
	int							( *pfnSPR_Height )			( HSPRITEZ hPic, int frame );
	int							( *pfnSPR_Width )			( HSPRITEZ hPic, int frame );
	void						( *pfnSPR_Set )				( HSPRITEZ hPic, int r, int g, int b );
	...
	void						( *pfnSetCrosshair )		( HSPRITEZ hspr, wrect_t rc, int r, int g, int b );
...
// Added for user input processing
	...
	const struct model_s *		( *GetSpritePointer )		( HSPRITEZ hSprite );
